...
<style>
    ...
    /* Info Grid Styling - KUNCI PERBAIKAN DI SINI */
    .info-grid {
        display: flex;
        flex-direction: column;
        gap: 10px;
    ...
    .info-label {
        width: 200px; /* Lebar tetap agar sejajar vertikal */
        flex-shrink: 0; /* Mencegah label menyempit */
        font-weight: 600;
    ...
    .bg-role { background: #e0f2fe; color: #0369a1; }
    ...
    @media (max-width: 768px) {
        .info-label { width: 140px; font-size: 0.85rem; }
...
<div class="container-fluid px-4 py-4">
    <div class="header-wrapper">
        ...
        <a href="<?= base_url('admin/home') ?>" class="btn-action btn-home">
            <i data-lucide="home" size="18"></i> Kembali ke Dashboard
        </a>
    </div>
                    ...
                    <div class="col-md-4 text-center mb-4 mb-md-0">
                        <div class="photo-container">
                            <img id="preview-foto" class="profile-photo" 
                                 src="<?= base_url('profile/' . ($admin['foto'] ?: 'default.png')) ?>" 
                                 alt="Foto Profil">
                        ...
                        <h3 class="fw-800 mb-1" style="color: var(--text-main);"><?= $admin['nama'] ?? 'Admin' ?></h3>
                        <p class="text-muted">ID: <?= $admin['id'] ?? $admin['id_siswa'] ?? '1' ?></p>
                        
                        <div class="mt-4">
                            <form action="<?= base_url('admin/update_foto') ?>" method="post" enctype="multipart/form-data" id="form-foto">
                                <?= csrf_field() ?>
                    ...
                    <div class="col-md-8">
                        <div class="info-grid">
                            ...
                            <div class="info-item">
                                ...
                                <div class="info-value"><?= $admin['no_handphone'] ?? '-' ?></div>
                            </div>

                            <div class="info-item">
                                <div class="info-label"><i data-lucide="award" size="18"></i> Jabatan</div>
                                <div class="info-value">
                                    <span class="custom-badge bg-role">Administrator</span>
                                </div>
                            </div>
...
<script>
    ...
    // Fungsi otomatis upload setelah pilih file
